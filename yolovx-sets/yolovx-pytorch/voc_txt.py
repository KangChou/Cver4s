...
def dealvoc(vocdata_name):

    # print(root_path)
    root_path = '/data/my_cv/YOLOX/datasets/VOCdevkit/VOC'+vocdata_name
...
vocdata_name_list = ["2007","BCCD","mask"]
dealvoc("2007")
# for vocdata_name in vocdata_name_list:
#     dealvoc(vocdata_name)
